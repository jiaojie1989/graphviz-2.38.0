...
man7dir = $(mandir)/man7
am__installdirs = "$(DESTDIR)$(man7dir)" "$(DESTDIR)$(htmldir)" \
	"$(DESTDIR)$(txtdir)" "$(DESTDIR)$(pkgincludedir)"
NROFF = nroff
MANS = $(man_MANS)
DATA = $(html_DATA) $(txt_DATA)
...
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/graphviz.spec.in \
...
ACLOCAL = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/missing aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
...
ANN_LIBS = 
AR = ar
AUTOCONF = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/missing autoconf
AUTOHEADER = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/missing autoheader
AUTOMAKE = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/missing automake-1.16
AWK = awk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -fno-common -Wall
CPP = gcc -E
...
FONTCONFIG_CFLAGS = -I/usr/local/Cellar/fontconfig/2.13.0/include -I/usr/local/opt/freetype/include/freetype2
FONTCONFIG_CONFIG = 
FONTCONFIG_LIBS = -L/usr/local/Cellar/fontconfig/2.13.0/lib -L/usr/local/opt/freetype/lib -lfontconfig -lfreetype
FREETYPE2_CFLAGS = -I/usr/local/opt/freetype/include/freetype2
FREETYPE2_LIBS = -L/usr/local/opt/freetype/lib -lfreetype
FREETYPE_CONFIG = 
GDIPLUS_CFLAGS = 
GDIPLUS_HEADS = 
GDIPLUS_LIBS = 
...
GD_INCLUDES = -I/usr/local/Cellar/gd/2.2.5/include
GD_LIBS =  -lgd -lgd -lz -L/usr/local/opt/libpng/lib -L/usr/local/Cellar/libpng/1.6.32/lib -lpng16 -L/usr/local/opt/freetype/lib -L/usr/local/opt/freetype/lib -lfreetype -lfontconfig -ljpeg -ltiff -lwebp -liconv
GLADE_CFLAGS = 
GLADE_LIBS = 
GLITZ_CFLAGS = 
GLITZ_LIBS = 
...
GRAPHVIZ_VERSION_DATE = 20180928.0107
...
LUA_INSTALL_DIR = 
LUA_LIBS = 
MAKEINFO = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/missing makeinfo
MANIFEST_TOOL = :
MATH_LIBS = -lm
MCS = 
MINGW32 = no
...
Z_INCLUDES = 
Z_LIBS =  -lz
abs_builddir = /Users/jiaojie/Downloads/graphviz-2.38.0
abs_srcdir = /Users/jiaojie/Downloads/graphviz-2.38.0
abs_top_builddir = /Users/jiaojie/Downloads/graphviz-2.38.0
abs_top_srcdir = /Users/jiaojie/Downloads/graphviz-2.38.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/jiaojie/Downloads/graphviz-2.38.0/config/install-sh
...
DISTCLEANFILES = config.cache builddate.h ast_common.h FEATURE/* graphviz-2.38.0*
...
windows/Properties/AssemblyInfo.cs: $(top_builddir)/config.status $(top_srcdir)/windows/Properties/AssemblyInfo.cs.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
graphviz.spec: $(top_builddir)/config.status $(srcdir)/graphviz.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
installdirs-am:
	for dir in "$(DESTDIR)$(man7dir)" "$(DESTDIR)$(htmldir)" "$(DESTDIR)$(txtdir)" "$(DESTDIR)$(pkgincludedir)"; do \
...
install-data-am: install-htmlDATA install-man \
	install-pkgincludeHEADERS install-txtDATA
...
uninstall-am: uninstall-htmlDATA uninstall-man \
	uninstall-pkgincludeHEADERS uninstall-txtDATA
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	uninstall-am uninstall-htmlDATA uninstall-man uninstall-man7 \
	uninstall-pkgincludeHEADERS uninstall-txtDATA
...
.PHONY: rpm
rpm: dist
	rpmbuild -ta graphviz-2.38.0.tar.gz
#	rpmbuild -ta --define "rtest 1" graphviz-2.38.0.tar.gz

.PHONY: deb
deb: dist
	rm -rf graphviz-2.38.0
	zcat graphviz-2.38.0.tar.gz | tar xf -
	(cd graphviz-2.38.0; fakeroot make -f debian/rules binary)

.PHONY: pkg
pkg: dist
	tar xzf graphviz-2.38.0.tar.gz && make -C graphviz-2.38.0/macosx/build && mv graphviz-2.38.0/macosx/build/graphviz-*.pkg .
